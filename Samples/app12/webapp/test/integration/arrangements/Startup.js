sap.ui.define([
	"sap/ui/test/Opa5",
	"com/mjzsoft/demo/ui5/app12/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.mjzsoft.demo.ui5.app12.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.mjzsoft.demo.ui5.app12",
					async: true
				},
				hash: oOptions.hash,
